...
/** 
	...
	TestAdd Prueba la inserción de una cadena en la implementación de VectorHeap
**/
...
public class TestAdd {
	...
	public void testAddPaciente() {
		...
		Paciente pPrueba = new Paciente("Sandra", "Cálculos renales", "B");
		vQueue.add(pPrueba);
		VectorHeap<Paciente> pQueue = new VectorHeap<Paciente>(vQueue);
		
		// Test
		// Prueba la inserción en el VectorHeap
		Paciente pPrueba2 = new Paciente("Melissa", "15 puñalas", "A");
		pQueue.add(pPrueba2);
